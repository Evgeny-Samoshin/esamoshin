/* ═══════════════════════════════════════════════
   ...
   Владеет историей. Мягкая навигация: fetch страницы → подмена #page и SEO-узлов <head>
   → нырок, анимированный на самом #page (дым в нём не участвует). Реальные <a href> и
   отдельные файлы на месте, так что боты и «без JS» получают обычную навигацию — SEO не страдает.
   ═══════════════════════════════════════════════ */
'use strict';
...
(function () {
  ...
  function enter() {
    ...
    // Фокус не трогаем: шапка с навигацией идёт до h1, и перевод фокуса на заголовок
    // выбрасывал её из обхода по Tab. Дефолт браузера — обход с начала документа.
  }
